  ...
  return (
    <nav id="mobile-menu" style={{ display: "block" }}>
      <ul>
          ...
          <ul className="mega-menu">
            <li>
              ...
              <ul className="mega-item">
                <li>
                  <a href="product-details.html">Standard SHop Page</a>
                </li>
                <li>
                  <a href="product-details.html">Shop Right Sidebar</a>
                </li>
                <li>
                  <a href="product-details.html">Shop Left Sidebar</a>
                </li>
                <li>
        ...
        <li>
          <a href="shop.html">
            Phone and Electronics <i className="far fa-angle-down"></i>
          </a>
